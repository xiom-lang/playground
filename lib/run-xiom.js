 ...
 * @returns {Promise<{success: boolean, code: number, stdout: string, stderr: string, timedOut: boolean}>}
 */
function runProcess(bin, args, options) {
  ...
  return new Promise((resolve) => {
    ...
    try {
      ...
      resolve({ success: false, code: -1, stdout: '', stderr: String((err && err.message) || err), timedOut: false });
      return;
    }
